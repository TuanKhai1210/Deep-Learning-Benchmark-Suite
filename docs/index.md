...
<section class="team-section section container" id="team">
  ...
  </div><p class="team-note">Each member implements, tests, and explains their own contribution. Review rotation: Khoa → Thiên · Khải → Khoa · Thiên → Khải. Group name: Tiki-taka.</p>
</section>
